            ...
            <View style={styles.container}>
                <ImageBackground source={'bg_img'} style={styles.backgroundImage}>
                    ...
                    <View>
                        ...
                        <Text style={[styles.cardText, { marginTop: 10, marginLeft: 50 }]}>Minimum Diameter (KM) - {item.estimated_diameter.kilometers.estimated_diameter_min}</Text>
                        <Text style={[styles.cardText, {marginTop:0, marginLeft: 50 }]}>Maximum Diameter (KM) - {item.estimated_diameter.kilometers.estimated_diameter_max}</Text>
                        <Text style={[styles.cardText, {marginTop: -10, marginLeft: 50 }]}>Velocity (KM/H) - {item.close_approach_data[0].relative_velocity.kilometers_per_hour}
